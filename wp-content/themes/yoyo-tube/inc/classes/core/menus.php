          ...
          public function render_profile_image($current_user_id)
          {
                    if ($current_user_id): ?>
                              <li class="nav-item text-center profile_image_container">
                                        <a id="profile">
                                                  <?php
                                                  $profile_img = get_user_meta($current_user_id, 'profile_image', true)
                                                            ?: BUILD_PATH . "/images/profile_img.png";
                                                  ?>
                                                  <img src="<?= esc_url($profile_img) ?>" alt="Profile Image"
                                                            class="profile_image rounded-circle w-25">
                                        </a>
                              </li>
                    <?php endif;
          }
